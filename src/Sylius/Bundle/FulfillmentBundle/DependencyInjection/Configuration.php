                    ...
                    ->children()
                        ->arrayNode('file_type')
                            ...
                            ->children()
                                ...
                                ->scalarNode('form')->defaultValue('Sylius\Bundle\Fulfillment\Form\Type\FileTypeType')->end()
                        ...
                        ->arrayNode('fulfillment_provider')
                            ...
                            ->children()
                                ...
                                ->scalarNode('controller')->defaultValue('Sylius\\Bundle\\ResourceBundle\\Controller\\ResourceController')->end()
                                ->scalarNode('form')->defaultValue('Sylius\Bundle\Fulfillment\Form\Type\FulfillmentProviderType')->end()
                                ->scalarNode('repository')->end()
                            ->end()
                        ->end()
                        ...
                        ->arrayNode('protocol')
                            ...
                            ->children()
                                ...
                                ->scalarNode('controller')->defaultValue('Sylius\\Bundle\\ResourceBundle\\Controller\\ResourceController')->end()
                                ->scalarNode('form')->defaultValue('Sylius\Bundle\Fulfillment\Form\Type\ProtocolType')->end()
                                ->scalarNode('repository')->end()
                            ->end()
                        ->end()
                        ->arrayNode('provider_parameter')
                            ...
                            ->end()
                        ->end()
                        ->arrayNode('fulfillment')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('model')->defaultValue('Sylius\Component\Fulfillment\Model\Fulfillment')->end()
                                ->scalarNode('controller')->defaultValue('Sylius\\Bundle\\ResourceBundle\\Controller\\ResourceController')->end()
                                ->scalarNode('form')->defaultValue('Sylius\Bundle\Fulfillment\Form\Type\FulfillmentType')->end()
                                ->scalarNode('repository')->end()
                            ->end()
                        ->end()
                    ->end()

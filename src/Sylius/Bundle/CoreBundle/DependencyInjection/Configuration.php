                ...
                ->arrayNode('classes')
                    ...
                    ->children()
                        ...
                        ->arrayNode('group')
                            ...
                            ->end()
                        ->end()
                        ->arrayNode('order_shipping_state')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('model')->defaultValue('Sylius\Component\Core\Model\OrderShippingState')->end()
                                ->scalarNode('controller')->defaultValue('Sylius\Bundle\ResourceBundle\Controller\ResourceController')->end()
                            ->end()
                        ->end()
                        ->arrayNode('locale')
                            ...
                            ->end()
                        ->end()
                        ->arrayNode('price_type')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('model')->defaultValue('Sylius\Component\Core\Model\PriceType')->end()
                                ->scalarNode('controller')->defaultValue('Sylius\Bundle\ResourceBundle\Controller\ResourceController')->end()
                            ->end()
                        ->end()
                        ->arrayNode('product_variant_price')
                            ->addDefaultsIfNotSet()
                            ->children()
                        ...
                        ->arrayNode('product_variant_image')
                            ...
                            ->end()
                        ->end()
                        ->arrayNode('product_variant_image_type')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('model')->defaultValue('Sylius\Component\Core\Model\ProductVariantImageType')->end()
                                ->scalarNode('controller')->defaultValue('Sylius\Bundle\ResourceBundle\Controller\ResourceController')->end()
                            ->end()
                        ->end()
                    ->end()
